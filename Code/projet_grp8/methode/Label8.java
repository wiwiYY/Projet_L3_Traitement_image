...
public class Label8 {
    ...
    /**
     * Fonction getCC : colorie les forme en couleur
     * @param inImage
    ...
    /**
     * Fonction getNumberOfCC : compte le nombre de couleur sur une image sans compter le noir
     * @param image
     * @return le resultat
     */
    static public int getNumberOfCC(BufferedImage image) {
        ...
        return colors.size()-1; //-1 pour ne par compter le noir
    }
